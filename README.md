...
Define the methods log(), info(), warning(), error(), debug().

Add the ability to format log messages using templates.

Register the logger in the application and log messages to different channels (e.g., console, file).
