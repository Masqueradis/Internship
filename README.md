...
Define an interface Animal with methods makeSound(), eat(), and sleep().

Implement three classes: Dog, Cat, and Bird, inheriting from Animal.

Override the makeSound(), eat(), and sleep() methods in each child class.

Create instances of Dog, Cat, and Bird.

Call makeSound(), eat(), and sleep() for each instance.

Use __invoke function to call methods. 
